...
module.exports = {
    async handler(chatUpdate) {
        ...
        try {
            ...
            if (opts['gconly'] && !m.fromMe && !m.chat.endsWith('g.us')) return await conn.sendMessage(m.chat, { text: "*Maaf kak*\nMia Bot Tidak Bisa Digunakan digunakan di private chat\n\n_Hanya Bisa Digunakan Di Dalam Group_\n\nKlik bergabung ke grup\nJika Ingin Menggunakan Bot Ini.",   contextInfo: { externalAdReply: { showAdAttribution: true, title: "GROUP ONLY MODE",  body: wm,   thumbnailUrl: "https://i.postimg.cc/T3Mv38BC/IMG-20230813-234614.jpg", sourceUrl: sgc, mediaType: 1,   renderLargerThumbnail: true }}}, { quoted: m})
...
global.dfail = (type, m, conn) => {
    let reelthumb = 'https://i.postimg.cc/T3Mv38BC/IMG-20230813-234614.jpg'
    let msg = {
